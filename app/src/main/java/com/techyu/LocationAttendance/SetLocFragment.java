 ...
 * 地理围栏
 */
public class SetLocFragment extends Fragment
        implements
        OnClickListener,
        GeoFenceListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View SetLocLayout = inflater.inflate(R.layout.activity_attendance_setting, container,
                false);
        // 初始化地理围栏
        fenceClient = new GeoFenceClient(getActivity());

        bt_AddFence = SetLocLayout.findViewById(R.id.bt_addFence);
        bt_RemoveFence = SetLocLayout.findViewById(R.id.bt_removeFence);
        et_attendanceId = SetLocLayout.findViewById(R.id.et_attendanceId);
        et_attendanceRadius = SetLocLayout.findViewById(R.id.et_attendanceradisu);
        etKeyword = SetLocLayout.findViewById(R.id.et_keyword);
        mMapView = SetLocLayout.findViewById(R.id.map);
...
//    }
    ...
    public void onMapClick(LatLng point) {
       ...
       Toast.makeText(getActivity(), "选中地图坐标：" + centerLatLng.longitude + ","
...
//        tvGuide.setVisibility(View.GONE);
    ...
    private void resetViewRound() {
        ...
        Toast.makeText(getActivity(),"请点击地图选择打卡地点", Toast.LENGTH_LONG)
                .show();
    }
    ...
    private void addFence() {
        ...
        if (null == centerLatLng || TextUtils.isEmpty(radiusStr)) {
            Toast.makeText(getActivity(), "考勤参数不全", Toast.LENGTH_SHORT)
                    .show();
            return;
        }
    ...
    public void saveLoc(){
        ...
        CommonUtils.saveSettingNote(getActivity(), "LocData", LocMap);
